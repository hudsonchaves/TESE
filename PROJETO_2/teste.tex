...
% ---
\titulo{Três Ensaios em Rigidez de Preços}
\autor{Hudson Chaves Costa}
\local{Brasil}
\data{Novembro, 2014}
\instituicao{%
...
\preambulo{Projeto de Tese apresentado ao Programa de Pós-Graduação em Economia da Universidade Federal do Rio Grande do Sul na Área de Economia Aplicada.}
% ---
